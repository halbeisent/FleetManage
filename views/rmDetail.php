    ...
    <body>
        ...
        <nav>
            <div class="nav-wrapper nav-rc4">
                <a href="#!" class="brand-logo">Renault Megane IV Business</a>
        ...
        <div class="slider">
            <ul class="slides">
                <li>
                    <img src="../assets/img/cars/carspics/megane.jpg"> <!-- random image -->
                </li>
                <li>
                    <img src="../assets/img/cars/carspics/meganeinside.jpg"> <!-- random image -->
                </li>
            </ul>
        </div>
        <table>
