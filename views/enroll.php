...
<!--         Material Design icons 
        ...
        <title>Inscription - FleetManage</title>
    </head>
    <body>
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="input-field col s12 m6 l6">
                                <input placeholder="Jean" id="firstName" name="firstName" type="text" class="validate" />
                                <label for="firstName">Prénom</label>
                                <p class="error"><?= isset($formError['firstName']) ? $formError['firstName'] : '' ?></p>
                            </div>
                            <div class="input-field col s12 m6 l6 ">
                                <input placeholder="Dupont" id="lastName" name="lastName" type="text" class="validate" />
                        ...
                        <div class="row">
                            <div class="input-field col s12 m6 l6">
                                <input placeholder="05/04/1994" id="birthDate" name="birthDate" type="text" class="datepicker" />
                        ...
                        <div class="row">
                            <div class="input-field col s12 m6 l2">
                                <input placeholder="285" id="streetNumber" name="streetNumber" type="text" class="validate" />
                            ...
                            <div class="input-field col s12 m6 l10">
                                <input placeholder="rue du parc" id="streetName" name="streetName" type="text" class="validate" />
                        ...
                        <div class="row">
                            <div class="input-field col s12 m6 l2">
                                <input placeholder="60400" id="zipCode" name="zipCode" type="text" class="validate" />
                                <label for="zipCode">Code postal</label>
                                <p class="error"><?= isset($formError['zipCode']) ? $formError['zipCode'] : '' ?></p>
                            </div>
                            <div class="input-field col s12 m6 l10">
                                <input placeholder="Noyon" id="city" name="city" type="text" class="validate" />
