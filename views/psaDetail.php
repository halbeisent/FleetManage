...
<html>
    ...
    <body>
        ...
        <nav>
            <div class="nav-wrapper nav-p208">
                <a href="#!" class="brand-logo">Peugeot 208 Style</a>
        ...
        <div class="slider col s12 m6 l4">
            <ul class="slides">
                <li>
                    <img src="../assets/img/cars/carspics/208.jpg"> <!-- random image -->
                </li>
                <li>
                    <img src="../assets/img/cars/carspics/208inside.jpg"> <!-- random image -->
                </li>
            </ul>
        </div>
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>Continental EcoContact 175/75/16</td>
                </tr>
                <tr>
                    <td>Usure Pneus</td>
                    <td>1000 Kms</td>
        ...
        <footer class="page-footer nav-p208">
            <div class="container">
                <div class="row">
